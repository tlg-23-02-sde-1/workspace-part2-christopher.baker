...
public class OrderTest {
  ...
  @Before
  public void init() {
    productCart = new ShoppingCart<Product>();            //the T is Product
    productCart.addItem(new MusicItem("CD-501"));
    productCart.addItem(new MediaPlayer("MP3-LP150"));
    
    musicCart = new ShoppingCart<MusicItem>();            //the T is MusicItem
    musicCart.addItem(new MusicItem("CD-521"));
    musicCart.addItem(new MusicItem("CD-514"));
    
    mediaCart = new ShoppingCart<MediaPlayer>();          //the T is MediaPlayer
  ...
  public void testProcessCart() {
    ...
    Order order2 = new Order("order-2");  //passing ShoppingCar<MusicItem>
    order2.processCart(musicCart);

    Order order3 = new Order("order-3");  //passing ShoppingCart<MediaItem>
